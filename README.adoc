...
For **Spring Boot 3**, Spring Cloud is optional. See <<how-to-use, How to use>> below.
...
NOTE: Starting from version 3.1.X, Spring Cloud is optional for Spring Boot 3 applications.

[[how-to-use]]
== How to use

. https://docs.docker.com/install/[Install Docker] on your machine
. For Spring Boot 2.X, make sure you have http://projects.spring.io/spring-cloud/#quick-start[Spring Boot and Spring Cloud] in classpath of your tests.
...
+
NOTE: For Spring Boot 3, Spring Cloud is optional.
+
.pom.xml
[source,xml]
----
